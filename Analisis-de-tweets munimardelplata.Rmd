---
title: "Análisis de Tweets de la Municipalidad de General Pueyrredón"
...
palabras_inutiles <- c('rt','u' ,'t.co', 'https', 'tan', 'Alberto', 'Fernandez', 'alberto', 'fernandez', 'fernández', 'n', 'fe0f', 's', 'm', 'gt', 'lan', 'd', 'as')
...
fav <- str_sub(MensajeMasFaveado$ext_media_expanded_url,44,62)
RT <- str_sub(MensajeMasRetuiteado$ext_media_expanded_url,44,62)
